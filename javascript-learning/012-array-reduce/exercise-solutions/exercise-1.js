/*
    ...
    2. Create a var called "modded" that reduces the "companies"
...
var companies = ["apple", "tesla", "spacex", "amazon", "meta", "google", "ibm"];

var modded = companies.reduce((result, company, i) => {
