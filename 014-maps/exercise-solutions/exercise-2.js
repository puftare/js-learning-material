/*
    1. Create the following 3 objects:
        - var banana = {name: "banana", quantity: 1, price: 1.95}
        - var apple = {name: "apple", quantity: 1, price: 1.45}
        - var candy = {name: "candy", quantity: 1, price: 3.50}
...
var banana = { name: "banana", quantity: 1, price: 1.95 };
var apple = { name: "apple", quantity: 1, price: 1.45 };
var candy = { name: "candy", quantity: 1, price: 3.5 };
...
for (var i = 0; i < store.get("products").length; i++) {
