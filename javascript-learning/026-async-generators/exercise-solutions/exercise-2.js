...
var letterGenerator = async function* (sentence) {
...
var letterGeneratorObject = letterGenerator("Monkeys are the coolest animal!");

var executeLetter = async () => {
  for await (var letter of letterGeneratorObject) {
    console.log(letter);
  }
};
executeLetter();
