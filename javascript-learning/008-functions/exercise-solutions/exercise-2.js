/*
    ...
    4. Test the function like so:
     - var test = login('hello', 'meow'); // "test" should be false
     - var test2 = login('admin', 'lol'); // "test2" should be true
     - var test3 = login('monkey', '123'); // "test3" should be true
     - var test4 = login('moomoo', 'farm'); // "test4" should be true
     - var test5 = login('moomoo', 'moo'); // "test5" should be false
*/
